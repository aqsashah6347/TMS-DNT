// src/Features/teams/components/TeamManagerPicker.jsx
import { useEffect, useLayoutEffect, useMemo, useRef, useState } from "react";
import { createPortal } from "react-dom";
import { Search, Check, X, Filter } from "lucide-react";
import { employeesApi } from "../../../api/employeesApi";

// Manager picker for the New/Edit Team modal. Same search-bar +
// standalone Filters-icon pattern as TeamMemberPicker (Department +
// Branch), single-select instead of multi. Both the results dropdown
// and the filters popover portal to document.body and position
// themselves with `position: fixed` off their own trigger, since the
// modal is `overflow-y: auto; max-height: 90vh`.
//
